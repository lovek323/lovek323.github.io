jQuery(document).ready(function($){
    ...
    function updateSidebarPosition() {
        var articlesWrapperTop = wrapper.offset().top,
            articlesWrapperHeight = wrapper.outerHeight(),
    ...
    function checkMQ() {
        return window.getComputedStyle(wrapper.get(0), '::before').getPropertyValue('content').replace(/'/g, "").replace(/"/g, "");
    }
});
